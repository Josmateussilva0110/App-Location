#!/bin/bash
# ================================================================
# Build APK do localizacao-tracker via Docker
# ================================================================
# Uso:
...
if [ -f "./build/localizacao-tracker.apk" ]; then
  echo ""
  echo -e "${GREEN}╔══════════════════════════════════════════╗"
  echo "║   ✅ Build concluído com sucesso!         ║"
  echo "╚══════════════════════════════════════════╝${NC}"
  echo ""
  echo -e "  📱 APK: ${BLUE}./build/localizacao-tracker.apk${NC}"
  echo -e "  📏 Tamanho: $(du -h ./build/localizacao-tracker.apk | cut -f1)"
  echo ""
  echo -e "  ${YELLOW}Para instalar no dispositivo:${NC}"
  echo "  adb install ./build/localizacao-tracker.apk"
  echo ""
else
  echo ""
